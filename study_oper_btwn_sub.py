...
#3. suppress
    ...
    # Apply the function
        ...
        sub_stim_list=np.concatenate((stim_list_shift,stim_list_shift,stim_list_shift),axis=None)
    ...
    #now we need to use this normalized data to run the decoder
        ...
        L2_models_nr, L2_scores_nr, L2_predicts_nr, L2_trues_nr, L2_evidence_nr, L2_costs_nr, L2_chosenvoxels_nr, L2_sig_scores_nr = L2_xval(sub_study_bold_nr, sub_stim_list_nr, run_list_nr)
