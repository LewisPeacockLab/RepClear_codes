# modified operation data - between subject classification
...
for TR_shift in TR_shifts:
    for mask_flag in masks:
        for num in range(len(subs)):
            ...
            if clear_data == 0:
                ...
                if os.path.exists(
                    ...
                    run3_length = int((len(study_run3)))
            if num == 0:
                study_bold_sub1 = study_bold
            elif num == 1:
                study_bold_sub2 = study_bold
            elif num == 2:
                study_bold_sub3 = study_bold

        sub_study_bold = np.concatenate(
            (study_bold_sub1, study_bold_sub2, study_bold_sub3)
        )
        ...
        if clear_data == 0:
            ...
            f = open(
                "btwnsuboperation_%s_%s_%sTR lag_data.pkl"
