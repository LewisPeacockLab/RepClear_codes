...
for num in subs:
    ...
    for i in range(1,31):
        ...
        if (evi_df['scenes'][replace_inds].values.size) > 14:
            ...
            normalize=temp[:3].mean() #normalize values to first 2 TRs
...
ax=sns.lineplot(data=plot_group_replace_df,x='x',y='y',color='blue',label='Replace-old')

ax=sns.lineplot(data=plot_group_otherreplace_df,x='x',y='y',color='skyblue',label='Replace-new')

ax=sns.lineplot(data=plot_group_maintain_df,x='x',y='y',color='green',label='Maintain')

ax=sns.lineplot(data=plot_group_suppress_df,x='x',y='y',color='red',label='Suppress')

ax=sns.lineplot(data=plot_group_baseline_df,x='x',y='y',color='gray',label='Baseline')
...
ax=sns.lineplot(data=plot_group_diffreplace_df,x='x',y='y',color='blue',label='Replace')
ax=sns.lineplot(data=plot_group_diffsuppress_df,x='x',y='y',color='red',label='Suppress')
