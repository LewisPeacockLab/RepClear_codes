    ...
    for task_flag in task_flags:
        ...
        for num in range(len(subs)):
            ...
            mask_path = os.path.join(
                ...
                sub,
                "new_mask",
                "VVS_%s_%s_mask.nii.gz" % (task_flag, brain_flag),
            )
        ...
        os.system(
            "fslmaths %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -bin %s"
            % (
                roi_paths[0],
                roi_paths[1],
                roi_paths[2],
