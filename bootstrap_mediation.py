...
for i in range(n_iterations):
    ...
    for op in operations:
        ...
        results_dict["Prop_med_control"] = summary_table.loc[
            "Prop. mediated (control)", "Estimate"
        ]
        results_dict["Prop_med_treated"] = summary_table.loc[
            "Prop. mediated (treated)", "Estimate"
        ]
        results_dict["Prop_med_avg"] = summary_table.loc[
