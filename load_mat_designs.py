...
sub_folders = {subIDs[0]: "202110211", subIDs[1]: "202110221", subIDs[2]: "202110291"}
...
for sub in subIDs:
    ...
    mat_files = find(
        "dataMat*study*03*mat",
        os.path.join(data_dir, "repclear_%s/" % sub_folders[sub]),
    )  # for now this targets the study phase, run 3 (but each file contains the full subject design)
    ...
    df_map = {
        "pre_localizer_design": pre_localizer_df,
        "study_design": study_df,
        "post_localizer_design": post_localizer_df,
    }
