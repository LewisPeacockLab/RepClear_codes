...
for subID in subIDs:
    ...
    clf, pca = load_model('/scratch/06873/zbretton/tacc_tools/cross_exp_code/trained_models.pkl')
    ...
    if not os.path.exists(os.path.join('/scratch/06873/zbretton',"group_cross_exp_results")):
        os.makedirs(os.path.join('/scratch/06873/zbretton',"group_cross_exp_results"))


    file_path = os.path.join('/scratch/06873/zbretton',f"group_cross_exp_results/{subID}_cross_exp_results.json")
...
ax=sns.violinplot(data=plot_df,x='Operation',y='AUCs',palette='Greys',inner='quartile')
