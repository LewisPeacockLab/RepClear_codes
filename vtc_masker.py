    ...
    for task_flag in task_flags:
        for num in range(len(subs)):
            ...
            def new_mask(subject_path):
                ...
                lh_parahippocampal_anterior = [
                    os.path.join(outdir, "lh_parahippocampal_anterior"),
                    1006,
                ]
                rh_parahippocampal_anterior = [
                    os.path.join(outdir, "rh_parahippocampal_anterior"),
                    2006,
                ]

                lh_parahippocampal = [
                    os.path.join(outdir, "lh_parahippocampal.nii.gz"),
                    1016,
                ]
                rh_parahippocampal = [
                    os.path.join(outdir, "rh_parahippocampal.nii.gz"),
                    2016,
                ]

                lh_inferiortemporal = [
                    os.path.join(outdir, "lh_inferiortemporal.nii.gz"),
                    1009,
                ]
                rh_inferiortemporal = [
                    os.path.join(outdir, "rh_inferiortemporal.nii.gz"),
                    2009,
                ]
                ...
                lh_lateraloccipital = [
                    os.path.join(outdir, "lh_lateraloccipital.nii.gz"),
                    1011,
                ]
                rh_lateraloccipital = [
                    os.path.join(outdir, "rh_lateraloccipital.nii.gz"),
                    2011,
                ]
                ...
                lh_temporal_pole = [
                    os.path.join(outdir, "lh_temporalpole.nii.gz"),
                    1033,
                ]
                rh_temporal_pole = [
                    os.path.join(outdir, "rh_temporalpole.nii.gz"),
                    2033,
                ]

                lh_middletemporal = [
                    os.path.join(outdir, "lh_middletemporal.nii.gz"),
                    1015,
                ]
                rh_middletemporal = [
                    os.path.join(outdir, "rh_middletemporal.nii.gz"),
                    2015,
                ]

                lh_superiortemporal = [
                    os.path.join(outdir, "lh_superiortemporal.nii.gz"),
                    1030,
                ]
                rh_superiortemporal = [
                    os.path.join(outdir, "rh_superiortemporal.nii.gz"),
                    2030,
                ]

                lh_pericalcarine = [
                    os.path.join(outdir, "lh_pericalcarine.nii.gz"),
                    1021,
                ]
                rh_pericalcarine = [
                    os.path.join(outdir, "rh_pericalcarine.nii.gz"),
                    2021,
                ]
                ...
                for roi in [
                    ...
                    os.system(
                        "fslmaths %s -thr %s -uthr %s %s"
                        % (aparc_aseg, roi[1], roi[1], roi[0])
                    )
                out_mask = os.path.join(
                    outdir, "VVS_%s_%s_mask.nii.gz" % (task_flag, brain_flag)
                )

                os.system(
                    "fslmaths %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -add %s -bin %s"
                    % (
                        lh_fusiform[0],
                        rh_fusiform[0],
                        lh_parahippocampal[0],
                        rh_parahippocampal[0],
                        lh_parahippocampal_anterior[0],
                        rh_parahippocampal_anterior[0],
                        lh_inferiortemporal[0],
                        rh_inferiortemporal[0],
                        lh_lingual[0],
                        rh_lingual[0],
                        lh_lateraloccipital[0],
                        rh_lateraloccipital[0],
                        lh_calcarine[0],
                        rh_calcarine[0],
                        lh_cuneus[0],
                        rh_cuneus[0],
                        ...
                        lh_middletemporal[0],
                        rh_middletemporal[0],
                        lh_superiortemporal[0],
                        rh_superiortemporal[0],
                        lh_pericalcarine[0],
                        rh_pericalcarine[0],
                        out_mask,
                    )
