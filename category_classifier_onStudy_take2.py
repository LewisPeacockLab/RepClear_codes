...
def visualize_evidence():
    ...
    ax=sns.lineplot(data=group_evidence_df.loc[(group_evidence_df['condition']=='replace') & (group_evidence_df['evidence_class']=='scenes')], x='TR',y='evidence',color='blue',label='Replace', ci=68, err_kws={'alpha':0.65})
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(data_dir,'figs','group_level_category_decoding_during_removal_v2.svg'))
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(data_dir,'figs','group_level_category_decoding_removal_minus_maintain_v2.svg'))    
